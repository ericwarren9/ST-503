...
Therefore our final equation in matrix format $\mathbf{y} = \mathbf{X} \mathbf{\beta} + \mathbf{e}$ where $mathbf{y}$ is a (3n x 1) matrix, $mathbf{X}$ is a (3n x 5) matrix, $mathbf{\beta}$ is a (1 x 5) matrix, and $mathbf{e}$ is a (3n x 1) matrix is 
...
## Part B (Finish to understand normal equations)
